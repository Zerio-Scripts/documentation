...
If you're using pma-voice and do not get "mic clicks" when using the radio, remove [this line](https://github.com/AvarianKnight/pma-voice/blob/main/client/init/main.lua#L232) from pma-voice.

<Callout>
  Please note: The line number for older versions of pma-voice is 220, and newer is 232.
  The line you should be removing is the "if check" line in the "playMicClicks" function.

  <Image src="/radio_mic_clicks_img.png" alt="Image of the line to remove" width={1131} height={399} quality={100} />
</Callout>
